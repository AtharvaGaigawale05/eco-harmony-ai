  ...
  head: () => ({
    meta: [
      { title: "EcoTrack AI — Your AI Sustainability Coach" },
      {
        name: "description",
        content:
          "Track your carbon footprint, get personalized AI sustainability advice, and build eco-friendly habits with gamified challenges.",
      },
      { property: "og:title", content: "EcoTrack AI — Your AI Sustainability Coach" },
      {
        property: "og:description",
        content: "Track your carbon footprint and get personalized AI sustainability advice.",
      },
    ],
  }),
  component: Index,
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-6xl px-4 pt-20 pb-24 text-center">
          ...
          <p className="mt-6 max-w-2xl mx-auto text-muted-foreground text-base sm:text-lg">
            EcoTrack AI calculates your carbon footprint, coaches you with personalized AI advice,
            and turns daily habits into a gamified mission for the planet.
          </p>
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            <Link
              to="/calculator"
              className="inline-flex items-center gap-2 rounded-xl bg-gradient-eco px-5 py-3 text-sm font-semibold text-primary-foreground shadow-glow hover:opacity-90 transition"
            >
          ...
          {[
            {
              ...
              desc: "Transport, energy, food, water and waste — measured in seconds.",
            },
            {
              icon: Bot,
              title: "AI coach",
              desc: "Personalized, motivational guidance grounded in your data.",
            },
            {
              icon: LayoutDashboard,
              title: "Live dashboard",
              desc: "Beautiful charts that show trends and category breakdowns.",
            },
            {
              icon: Trophy,
              title: "Eco challenges",
              desc: "Gamified missions and badges to build sustainable habits.",
            },
          ].map((f) => (
        ...
        <div className="mx-auto max-w-6xl px-4 pb-24">
          <div className="glass rounded-3xl p-8 sm:p-12 text-center shadow-elegant">
            ...
            <p className="mt-2 max-w-xl mx-auto text-muted-foreground text-sm sm:text-base">
              Small, consistent changes compound. Start with your footprint and let your AI coach
              take it from there.
            </p>
            <div className="mt-6 flex flex-wrap justify-center gap-6 text-xs text-muted-foreground">
              <span className="inline-flex items-center gap-1.5">
                <ShieldCheck className="size-4 text-primary" aria-hidden /> Private — data stays in
                your browser
              </span>
              <span className="inline-flex items-center gap-1.5">
                <Gauge className="size-4 text-primary" aria-hidden /> Fast, accessible UI
              </span>
              <span className="inline-flex items-center gap-1.5">
                <Sparkles className="size-4 text-primary" aria-hidden /> Powered by Lovable AI
              </span>
            </div>
          </div>
        </div>
