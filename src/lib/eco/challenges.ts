...
export const CHALLENGES: Challenge[] = [
  ...
  },
  {
    ...
    description: "Replace car commutes with cycling 3+ days.",
    xp: 200,
    category: "transport",
    durationDays: 7,
  },
  {
    ...
    description: "Keep showers under 5 minutes for a week.",
    xp: 120,
    category: "water",
    durationDays: 7,
  },
  {
    id: "minimal-energy",
    title: "Minimal Electricity Day",
    description: "Unplug non-essentials for 24 hours.",
    xp: 80,
    category: "energy",
    durationDays: 1,
  },
  {
    id: "meatless-week",
    title: "Meatless Week",
    description: "Try a fully plant-based menu for 7 days.",
    xp: 180,
    category: "food",
    durationDays: 7,
  },
  {
    ...
    description: "Plan meals and compost scraps for 7 days.",
    xp: 130,
    category: "waste",
    durationDays: 7,
  },
